...
assert.equal(metrics[0].secondMonthRetentionPct.toFixed(2), '321.71', '2025-06 次月留存金额比例不正确');
assert.equal(metrics[0].thirdMonthRetentionPct.toFixed(2), '248.39', '2025-06 第三月留存金额比例不正确');
assert.equal(metrics[7].secondMonthRetentionPct.toFixed(2), '102.82', '2026-01 次月留存金额比例不正确');
...
assert.equal(averages.secondMonthRetentionPct.toFixed(2), '191.35', '平均次月留存金额比例不正确');
assert.equal(averages.thirdMonthRetentionPct.toFixed(2), '118.33', '平均第三月留存金额比例不正确');
